...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAERS1FkZj1J5cXHH-8YrYJu276aG3L98AAC_AYAAkQ-IVcCl2XzLYA5RS8E")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[𝗧ᴇʟᴇɢʀᴀᴍ 𝗠ᴇᴅɪᴀ](https://t.me/tamilchats_makkal) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
                ...
                [
                    [
                        InlineKeyboardButton(
                            text="• 𝗬ᴏᴜᴛᴜʙᴇ •", url=f"{link}"
                        ),
                        InlineKeyboardButton(
                            text="• 𝗦ᴜᴩᴩᴏʀᴛ •", url="https://t.me/tamilchats_makkal"
                        ),
                    ],
                ]
            )
